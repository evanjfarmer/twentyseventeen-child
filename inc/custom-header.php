...
function childtheme_video_controls( $settings ) {
    $settings['l10n']['play'] = '<span>'__( 'Play my awesome video', 'twentyseventeenchild' );'</span>'
    $settings['l10n']['pause'] = '<span>'__( 'Pause my awesome video', 'twentyseventeenchild' ); '</span>'
    return $settings;
}
